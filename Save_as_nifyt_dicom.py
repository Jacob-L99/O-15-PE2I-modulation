...
def construct_affine(pixel_spacing, slice_thickness, coordinate_position):
    ...
    x_origin, y_origin, z_origin = coordinate_position
...
def save_as_nifti(directory ,arrays, filenames, arrays_pat, filenames_pat, pixel_spacing, slice_thickness, image_positions):
    ...
    for idx, (array, fname) in enumerate(zip(arrays, filenames), start=1):
        ...
        affine = np.array([
                    [-pixel_spacing[0], 0, 0, image_position[0]],  # X-axis: pixel spacing and position
                    [0, pixel_spacing[1], 0, image_position[1]],   # Y-axis: pixel spacing and position
                    [0, 0, slice_thickness, image_position[2]],    # Z-axis: slice thickness and position
        ...
        """
        pixel_spacing=[1.9, 1.9]
        slice_thickness=2.8
        coordinate_position=(-124.02343750000, -124.02343750000, -257.64999389648)
